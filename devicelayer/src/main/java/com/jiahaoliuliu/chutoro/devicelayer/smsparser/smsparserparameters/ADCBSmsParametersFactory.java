...
public class ADCBSmsParametersFactory implements ISmsParametersFactory {

    private static final String SENDER = "ADCBAlert";
    ...
    private static final String PATTERN_2 = "(.*?) withdrawn from acc.(.*?) on (.*?) at (.*?)\\.";
